...
* @param <map::iterator> [it]    map iterator
*
* @return void
*/
...
* @param <int>          [sat]     sat#
* @param <NavData_t>    [*eph]    ephemeris data (GPS/GAL/BDS)
*
...
* @param <int>             [sat]     sat #
* @param <NavData_t>       [*geph]   ephemeris data (GLO)
*
* @return <int> 0:error 1:ok
*/
...
* @param <double>    [*data] nav data array
* @param <NavData_t> [*eph]  GLO ephemeris data
*
* @return <int> 0: error 1: ok
*/
...
* @param <int>    [tsys]    time system
* @param <char>   [tobs]    obs type array
* @param <vector> [*obsall] obs data vector
*
...
*
* @return <int> -1:read file fail 0:error 1:ok
*/
...
* @param <FILE>      [*fp]     file pointer
* @param <char>      [*type]   rinex data type
* @param <vector>    [*obsall] obs receiver data vector
* @param <NavPack_t> [*navall] nav data packet
* @param <Station_t> [*sta]    station information
*
* @return <int> 0:error 1:ok
...
*
* @return <PCV_t> [*pcv] fit PCV of sat#
*/
